      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1, padding: "60px 72px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 48 }}>
            ...
            {bank && (
              <span style={{ background: "#ffffff15", border: "1px solid #ffffff25", color: "#9ca3af", borderRadius: 999, padding: "6px 16px", fontSize: 16 }}>
                🌍 {bank.country}
              </span>
            )}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", flex: 1, justifyContent: "center" }}>
            <div style={{ color: "#6b7280", fontSize: 20, marginBottom: 16, textTransform: "uppercase", letterSpacing: 2 }}>Seed Bank</div>
            <div style={{ color: "#f9fafb", fontSize: 72, fontWeight: 800, lineHeight: 1.1, marginBottom: 24 }}>
              {bank?.name ?? slug.replace(/-/g, " ")}
            </div>
            {bank && (
              <div style={{ display: "flex", gap: 32, color: "#9ca3af", fontSize: 22 }}>
                <span>{bank.strain_count}+ strains</span>
                <span>·</span>
                <span>Ships to {bank.shipping_countries.length} countries</span>
                {bank.rating > 0 && (
                  <>
                    <span>·</span>
